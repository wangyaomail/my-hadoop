...
class ReduceTaskRunner extends TaskRunner {
    ...
    public boolean prepare() throws IOException {
        ...
        while (needed.size() > 0) {
            ...
            MapOutputLocation[] locs = jobClient.locateMapOutputs(task.getTaskId(), neededStrings);
            ...
            for (int i = 0; i < locs.length; i++) {
                ...
                MapOutputProtocol client = (MapOutputProtocol) RPC.getProxy(MapOutputProtocol.class,
                                                                            addr,
                                                                            this.conf);
                ...
                try {
                    ...
                    client.getFile(loc.getMapTaskId(),
                                   task.getTaskId(),
                    ...
                    LOG.log(Level.WARNING,
                            task.getTaskId() + " copy failed: " + loc.getMapTaskId() + " from " + addr,
                            e);
                } finally {
