...
public class NameNode implements ClientProtocol, DatanodeProtocol, FSConstants {
    ...
    public NameNode(Configuration conf) throws IOException {
        this(getDir(conf),
             DataNode.createSocketAddr(conf.get("fs.default.name", "local")).getPort(),
             conf);
    }
     ...
     *
     */
    public LocatedBlock create(
            String src, String clientName, String clientMachine, boolean overwrite)
            throws IOException {
