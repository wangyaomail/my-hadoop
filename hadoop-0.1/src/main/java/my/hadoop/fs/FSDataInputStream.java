...
public class FSDataInputStream extends DataInputStream {
  ...
  private class Checker extends FilterInputStream implements Seekable {
    private my.hadoop.fs.FileSystem fs;
    private File file;
    private FSDataInputStream sums;
    private Checksum sum = new CRC32();
    private int inSum;

    public Checker(my.hadoop.fs.FileSystem fs, File file, Configuration conf)
      throws IOException {
  ...
  public FSDataInputStream(my.hadoop.fs.FileSystem fs, File file, int bufferSize, Configuration conf)
      throws IOException {
    super(null);
  ...
  public FSDataInputStream(my.hadoop.fs.FileSystem fs, File file, Configuration conf)
    throws IOException {
    super(null);
