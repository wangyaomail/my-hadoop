...
public class ExampleDriver {
    ...
    static private class ProgramDescription {
        ...
        public ProgramDescription(
                Class mainClass, String description)
    ...
    private static void printUsage(Map programs) {
        ...
        for (Iterator itr = programs.entrySet().iterator(); itr.hasNext(); ) {
            ...
            System.out.println("  " + (String) item.getKey() + ": " + ((ProgramDescription) item.getValue()).getDescription());
        }
    }
    ...
    public static void main(String[] args) throws Throwable {
        ...
        programs.put("wordcount",
                     new ProgramDescription(WordCount.class,
                                            "A map/reduce program that counts the words in the input files."));
        programs.put("grep",
                     new ProgramDescription(Grep.class,
