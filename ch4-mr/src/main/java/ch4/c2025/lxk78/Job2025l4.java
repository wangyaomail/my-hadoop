...
public class Job2025l4 {
    static class MyMapper extends Mapper<LongWritable, Text, Text, Text> {
        ...
        protected void map(LongWritable key, Text value, Mapper<LongWritable, Text, Text, Text>.Context context) throws IOException, InterruptedException {
            ...
            if(toks.length==8){
                String prv = toks[6].substring(0,3);
    ...
    static class MyReducer extends Reducer<Text, Text, Text, Text> {
        ...
        protected void reduce(Text key, Iterable<Text> values, Reducer<Text, Text, Text, Text>.Context context) throws IOException, InterruptedException {
            ...
            context.write(new Text("第三大"), new Text(list.get(2).getKey()+":"+list.get(2).getValue()));
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = Job.getInstance(conf, Job2025l4.class.getSimpleName());
        job.setJarByClass(Job2025l4.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("C:\\nos\\my-hadoop\\output\\"+ Job2025l4.class.getSimpleName()));
