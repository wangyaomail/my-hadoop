...
public class Job2025C78J3 {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = Job.getInstance(conf, Job2025C78J3.class.getSimpleName());
        job.setJarByClass(Job2025C78J3.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("C:\\nos\\my-hadoop\\output\\"+ Job2025C78J3.class.getSimpleName()));
