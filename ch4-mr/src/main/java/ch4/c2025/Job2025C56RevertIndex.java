...
public class Job2025C56RevertIndex {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = Job.getInstance(conf, Job2025C56RevertIndex.class.getSimpleName());
        job.setJarByClass(Job2025C56RevertIndex.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("C:\\nos\\my-hadoop\\output\\"+ Job2025C56RevertIndex.class.getSimpleName()));
