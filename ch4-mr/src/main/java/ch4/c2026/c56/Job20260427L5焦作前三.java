...
public class Job20260427L5焦作前三 {
        ...
        protected void map(LongWritable key, Text value, Mapper<LongWritable, Text, Text, Text>.Context context) throws IOException, InterruptedException {
            ...
            if(toks.length==8){
                if (toks[6].contains("焦作")){
                    context.write(new Text("1"), new Text(toks[0]+"\t"+toks[7]));
                }
            }
        }
    }
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = Job.getInstance(conf, Job20260427L5焦作前三.class.getSimpleName());
        job.setJarByClass(Job20260427L5焦作前三.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("C:\\nos\\my-hadoop\\output\\"+ Job20260427L5焦作前三.class.getSimpleName()));
