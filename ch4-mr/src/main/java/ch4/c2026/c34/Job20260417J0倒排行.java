...
public class Job20260417J0倒排行 {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = Job.getInstance(conf, Job20260417J0倒排行.class.getSimpleName());
        job.setJarByClass(Job20260417J0倒排行.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("C:\\nos\\my-hadoop\\output\\"+ Job20260417J0倒排行.class.getSimpleName()));
