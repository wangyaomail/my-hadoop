...
public class Job20260410J3最高最低分 {
    static class MyMapper extends Mapper<LongWritable, Text, Text, Text> {
        ...
        protected void cleanup(Mapper<LongWritable, Text, Text, Text>.Context context) throws IOException, InterruptedException {
            ...
            context.write(new Text("1"), new Text(min+""));
    ...
    static class MyReducer extends Reducer<Text, Text, Text, Text> {
        ...
        protected void reduce(Text key, Iterable<Text> values, Reducer<Text, Text, Text, Text>.Context context) throws IOException, InterruptedException {
            ...
            for(Text val : values){
                ...
                if(min>Integer.parseInt(val.toString())){
                    min = Integer.parseInt(val.toString());
                }
            }
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = Job.getInstance(conf, Job20260410J3最高最低分.class.getSimpleName());
        job.setJarByClass(Job20260410J3最高最低分.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("C:\\nos\\my-hadoop\\output\\"+ Job20260410J3最高最低分.class.getSimpleName()));
