...
public class Job20260417J2PR0入边 {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = Job.getInstance(conf, Job20260417J2PR0入边.class.getSimpleName());
        job.setJarByClass(Job20260417J2PR0入边.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("C:\\nos\\my-hadoop\\output\\"+ Job20260417J2PR0入边.class.getSimpleName()+".mid"));
        if(job.waitForCompletion(true)){
            Job job2 = Job.getInstance(conf, Job20260417J2PR0入边.class.getSimpleName());
            job2.setJarByClass(Job20260417J2PR0入边.class);
            ...
            FileOutputFormat.setOutputPath(job2, new Path("C:\\nos\\my-hadoop\\output\\"+ Job20260417J2PR0入边.class.getSimpleName()+".final"));
