...
public class Job20260427L2山西同学成绩 {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = Job.getInstance(conf, Job20260427L2山西同学成绩.class.getSimpleName());
        job.setJarByClass(Job20260427L2山西同学成绩.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("C:\\nos\\my-hadoop\\output\\"+ Job20260427L2山西同学成绩.class.getSimpleName()));
